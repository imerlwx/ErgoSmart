...
class ErgoSolCap():
    ...
    def get_dataset(self):
        ...
        # files_rebartying_back      = load_files(r".\Images\rebarTying_back")
        # files_rebartying_knee      = load_files(r".\Images\rebarTying_knee")
        # files_ceilingwork_shoulder = load_files(r".\Images\overhead_shoulder")
        # files_window_shoulder      = load_files(r".\Images\window_shoulder")
        # files_vibration_hand       = load_files(r".\Images\vibration_hand")
        # files_load_cart            = load_files(r".\Images\load_cart_back")
        # files_pick_back            = load_files(r".\Images\pick_product_back")
        # files_pick_knee            = load_files(r".\Images\pick_product_knee")
        # files_pick_shoulder        = load_files(r".\Images\pick_product_shoulder")
    ...
    def train(self):
        ...
        test_dataset = load_dataset("imagefolder", data_dir=getPath("./folder"), split="test")
