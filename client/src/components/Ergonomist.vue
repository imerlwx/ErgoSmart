...
<template>
    <main>
        <h2>
            Instructions:
            Here are the problems or solutions the users are not satisfied with.
            The images with potential ergonomic problems are shown on the left.
            The problems generated by the model are shown on the middle top. You can revise it directly.
            You can add more solutions to the corresponding problem in the middle bottom area.
            You can do the modifications based on the feedback of users on the right.
            Notice: do not add solutions that are already generated by the model on the right.
            After finished, please click the "Save" button.
        </h2>
