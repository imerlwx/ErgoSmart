...
<template>
    <main>
        <el-card>
                ...
                <ul>
                    <li>Here are the problems or solutions the users are not satisfied with.</li>
                    <li>The images with potential ergonomic problems are shown on the left.</li>
                    <li>The problems generated by the model are shown on the middle top. You can revise it directly.</li>
                    <li>You can add more solutions to the corresponding problem in the middle bottom area.</li>
                    <li>You can do the modifications based on the feedback of users on the right.</li>
                    <li>Notice: do not add solutions that are already generated by the model on the right.</li>
                    <li>After finished, please click the "Save" button.</li>
                </ul>
        ...
        <ul v-else>
            <li v-for='t in trainings' :key='t.id'>
                <div class="list-item">
                    ...
                    <div class="result">
                        <p>Problem:</p>
                        <el-input type="textarea" resize="none" rows="4" v-model="t.result"
                            :style="{ fontSize: '16px' }"></el-input>
                        <p>New Solution:</p>
                        <el-input type="textarea" resize="none" rows="8" v-model="newSol[t.id]"
                            :style="{ fontSize: '16px' }"></el-input>
